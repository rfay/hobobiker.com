 ...
 */
?>
<!-- <?php print $linkurl ?> --><div class="flickrfloat"><div class="flickr-img-wrapper">
        <a rel="lightbox[group1][__description__<?php print $download_link ?>]" href="<?php print $linkurl ?>">
            <img src="<?php print $url ?>" alt="__description__" title="__description__" class="imagecache-<?php print $image_preset_name ?>

<?php print $class ? ' ' . $class : '' ?>" /></a></div>
<div class="caption generated-caption"><em>__description__</em></div>
</div>
