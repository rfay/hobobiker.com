...
function hobo_daisies_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function hobo_daisies_button($element) {
...
*/
function hobo_daisies_img_assist_page($content, $attributes = NULL) {
