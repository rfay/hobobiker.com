...
* Enter your API keys on Administer » Site configuration » Mollom » Settings.
...
* Go to Administer » Site configuration » Mollom.
...
* Go to Administer » Site configuration » Mollom » Settings.
